/**
 * H1 卡（book-admin）E2E 专用 Playwright 配置 — 不起 FE webServer。
 *
 ...
 *
 * 跑：
 *   pnpm test:v15h   →  playwright test --config=playwright-admin.config.ts tests/v15h-question-crud-admin.spec.ts
 */
